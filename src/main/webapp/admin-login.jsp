...
<head>
    ...
    <style>
        ...
        .login-container { margin: 90px auto; border: 1px solid #e2e8f0; box-shadow: 0 12px 28px rgba(15, 23, 42, .08); }
        h1 { color: #1e3a5f; }
...
<div class="login-container">
    ...
    <h1>Admin Login</h1>
    <p class="intro">Manage student records, marks and released results.</p>
